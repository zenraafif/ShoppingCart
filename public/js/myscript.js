    ...
    var cart = [];
        ...
        function addProduct() {
            ...
            for (var i = 0; i < products.length; i++) {
                html += "<tr>";
                html += "<td><input type='text' value='" + products[i].product_id + "'></td>";
                html += "<td><input type='text' value='" + products[i].product_desc + "'></td>";
                html += "<td><input type='text' value='" + products[i].product_qty + "'></td>";
                html += "<td><input type='text' value='" + products[i].product_price + "'></td>";
